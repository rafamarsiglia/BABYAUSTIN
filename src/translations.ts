...
export const translations = {
  en: {
    ...
    dressCodeDesc: "Dress in your favorite light colors—soft blues, greens, and pastels—to celebrate with us",
    dressCodeNote: "It would be nice to follow the suggested colors",
    message: "We are waiting for you with love to celebrate the upcoming arrival of our baby Austin.",
    gallery: "Gallery",
    rsvp: "RSVP",
    rsvpDeadline: "Please RSVP before May 25th, 2026",
    rsvpName: "Full Name",
    rsvpEmail: "Email",
  ...
  es: {
    ...
    dressCodeDesc: "Vístete con tus colores claros favoritos: azules suaves, verdes y pasteles, para celebrar con nosotros",
    dressCodeNote: "Sería lindo seguir los colores sugeridos",
    message: "Te esperamos con mucho amor para celebrar la próxima llegada de nuestro bebé Austin.",
    gallery: "Galería",
    rsvp: "Confirmar Asistencia",
    rsvpDeadline: "Por favor confirma antes del 25 de mayo de 2026",
